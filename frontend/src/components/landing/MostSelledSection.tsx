...
import classes from 'src/styles/components/landing/MostSelledSection.module.scss';
import {useAppSelector} from 'src/hooks/useAppSelector';
import {useAppDispatch} from 'src/hooks/useAppDispatch';
import {fetchAllItems } from 'src/store/thunks/item.thunk';
import MostSelledItem from 'src/components/landing/items/MostSelledItem';

import imgMacBookPro13 from 'src/static/png/mostSelled/MacBookPro13.png';
import imgGalaxyWatch3 from 'src/static/png/mostSelled/GalaxyWatch3.png';
import imgMacBookAirM1 from 'src/static/png/mostSelled/MacBookAirM1.png';
import imgIPad from 'src/static/png/mostSelled/iPad.png';
import {IItem} from 'src/types/landing.types';
import {mostSelledSection} from 'src/static/landing';

const MostSelectedSection: FC = () => {
...
export default MostSelectedSection;