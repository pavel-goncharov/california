import laptops from 'src/assets/png/laptops.png';
import watch from 'src/assets/png/watch.png';
import phones from 'src/assets/png/phones.png';
import tablet from 'src/assets/png/tablet.png';
import watches from 'src/static/png/bestAround/LatestAndGratest.png';
import laptopAndPhones from 'src/static/png/bestAround/bestSelling.png';
import laptopAndPhone from 'src/static/png/bestAround/everyProduct.png';
import imgIdeas from 'src/assets/png/ideas.png';
import searchSvg from 'src/assets/svg/search.svg';
import imgNeverMiss from 'src/assets/png/neverMiss.png';
import logo from 'src/assets/svg/title.svg';
import idSelectors from 'src/styles/components/landing/items/CategoryItemId.module.scss';
import {IAnythingElseSection, IBestAroundItem, IBestAroundSection, ICategoryItem, ICategorySection, IFooter, IFooterLink, IIdeasSection, IMostSelledSection, INeverMissSection, ISlideItem} from 'src/types/landing.types';
import iphonePng from 'src/assets/png/iphone.png';
